package com.aditi.insight.web.config;
...
public class CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		String accessControlAllowHeaders = GlobalConstants.HEADER_AUTH_TOKEN + ","
				+ "Origin, X-Requested-With,insight-file-name, Content-Type, Accept";
